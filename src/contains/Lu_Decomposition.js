...
import { calLu } from '../calculator'
const math = require('mathjs');

export default class Lu_Decomposition extends React.Component{
    ...
    onClickCalculator = (e)=>{
            ...
            this.setState({data : calLu(this.state.n,this.state.matrixA,this.state.matrixB)})
